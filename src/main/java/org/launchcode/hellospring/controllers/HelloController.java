...
//    }
    ...
    public String helloForm() {
        return "<html>" +
                "<body>" +
                "<form action='hello' method='post'>" + // submit a request to /hello. Pt added method='post'
                "<input type='text' name='name'>" + // already has name declared in path from method above
